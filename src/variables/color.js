export const theme = {
    ...
    //RegisterScreen
    registerBtnBlue:'#A4D3E6',
    registerBtnCyan:'#B9DEEC',
    inputBackground1:'#DDEDF5',
    inputBackground2:'#F1F1EF',
    registerEmerald:'#70BCC3',
    ...
    primeCostOrangeLight:'rgb(255,231,217)',

    //IngreModal
    ingreBackDarkGrey:'rgb(223,223,223)',

    //OriginCostModal
    originCostBlue:'#3587B9',
    originCostBlueLight:'rgb(221,239,242)',
};