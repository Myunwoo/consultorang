...
const OriginCostModal = ({ showModal, setShowModal,cost}) => {
    const data=[
        Math.round(cost*100/40/10)*10,
        Math.round(cost*100/35/10)*10,
        Math.round(cost*100/30/10)*10,
        Math.round(cost*100/25/10)*10,
        Math.round(cost*100/20/10)*10,
    ];
